...
const student: Student = { name: '', surname: '', age: 4, gender: 'male', Courses: Empty() }

const Select = <K extends Array<keyof Student>>(s: Student, ...props: K & IsUnique<K>): Pick<Student, K[number]> => {
